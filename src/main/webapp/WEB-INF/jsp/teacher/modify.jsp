    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="modify.do" method="post" class="main_form">
                ...
                <div class="input_info"><input type="text" class="readonly" readonly value="${param.costId }" name="costId" /></div>
                <div class="text_info clearfix"><span>资费名称：</span></div>
                <div class="input_info">
                    <input type="text" class="width300" name="name" value="${param.name }"/>
                ...
                <div class="input_info_high">
                    <textarea class="width300 height70" name="descr">没有启用的资费，可以修改除 ID 以外的所有信息</textarea>
