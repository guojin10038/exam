        	...
        	<form action="login.do" method="post">
	            <table>
	                ...
	                <tr>
	                    ...
	                    <!-- 路径后添加随机参数的意义在于欺骗服务器，让它以为路径有所改变，从而触发访问服务器 -->
	                    <td><img src="createImg.do" alt="验证码" title="点击更换" onclick="this.setAttribute('src','createImg.do?x='+new Date());"/></td>  
	                ...
	                <tr>
	                    ...
	                    <td class="login_button" colspan="2">
	                    	<!-- 
	                    		...
	                    		2.表单还有submit()，通过js可以调用，调用时会提交数据，其效果和触发onsubmit()事件一样
	                    	 -->
